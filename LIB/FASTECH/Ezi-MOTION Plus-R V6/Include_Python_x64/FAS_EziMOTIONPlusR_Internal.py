...
import ctypes
import sys
dll_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'EziMOTIONPlusRx64.dll'))


EziMOTIONPlusR_dll = ctypes.windll.LoadLibrary(dll_path)
...
# ------------------------------------------------------------------------------
# FAS_Connect 함수 정의
FAS_Connect_Original = EziMOTIONPlusR_dll["FAS_Connect"]
FAS_Connect_Original.argtypes = [ctypes.c_ubyte, ctypes.c_uint]
FAS_Connect_Original.restype = ctypes.c_int


# FAS_OpenPort 함수 정의
FAS_OpenPort_Original = EziMOTIONPlusR_dll["FAS_OpenPort"]
FAS_OpenPort_Original.argtypes = [ctypes.c_ubyte, ctypes.c_uint]
FAS_OpenPort_Original.restype = ctypes.c_int


# FAS_AttachSlave 함수 정의
FAS_AttachSlave_Original = EziMOTIONPlusR_dll["FAS_AttachSlave"]
FAS_AttachSlave_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_AttachSlave_Original.restype = ctypes.c_int


# FAS_Close 함수 정의
FAS_Close_Original = EziMOTIONPlusR_dll["FAS_Close"]
FAS_Close_Original.argtypes = [ctypes.c_ubyte]


# FAS_IsSlaveExist 함수 정의
FAS_IsSlaveExist_Original = EziMOTIONPlusR_dll["FAS_IsSlaveExist"]
FAS_IsSlaveExist_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
...
# ------------------------------------------------------------------------------
# FAS_EnableLog 함수 정의
FAS_EnableLog_Original = EziMOTIONPlusR_dll["FAS_EnableLog"]
FAS_EnableLog_Original.argtypes = [ctypes.c_int]


# FAS_SetLogLevel 함수 정의
FAS_SetLogLevel_Original = EziMOTIONPlusR_dll["FAS_SetLogLevel"]
FAS_SetLogLevel_Original.argtypes = [ctypes.c_int]


# FAS_SetLogPath 함수 정의
FAS_SetLogPath_Original = EziMOTIONPlusR_dll["FAS_SetLogPath"]
FAS_SetLogPath_Original.argtypes = [c_wchar_p_type]
FAS_SetLogPath_Original.restype = ctypes.c_int


# FAS_PrintCustomLog 함수 정의
FAS_PrintCustomLog_Original = EziMOTIONPlusR_dll["FAS_PrintCustomLog"]
FAS_PrintCustomLog_Original.argtypes = [ctypes.c_ubyte, ctypes.c_int, c_wchar_p_type]
...
FAS_GetSlaveInfo_Original = EziMOTIONPlusR_dll["FAS_GetSlaveInfo"]
...
FAS_GetMotorInfo_Original = EziMOTIONPlusR_dll["FAS_GetMotorInfo"]
...
FAS_GetSlaveInfoEx_Original = EziMOTIONPlusR_dll["FAS_GetSlaveInfoEx"]
FAS_GetSlaveInfoEx_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    POINTER(CDrive_Info)
]
...
FAS_SaveAllParameters_Original = EziMOTIONPlusR_dll["FAS_SaveAllParameters"]
FAS_SaveAllParameters_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_SaveAllParameters_Original.restype = ctypes.c_int


# FAS_SetParameter 함수정의
FAS_SetParameter_Original = EziMOTIONPlusR_dll["FAS_SetParameter"]
FAS_SetParameter_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    ctypes.c_int
...
FAS_GetParameter_Original = EziMOTIONPlusR_dll["FAS_GetParameter"]
...
FAS_GetROMParameter_Original = EziMOTIONPlusR_dll["FAS_GetROMParameter"]
...
# ------------------------------------------------------------------------------
# FAS_SetIOInput 함수정의
FAS_SetIOInput_Original = EziMOTIONPlusR_dll["FAS_SetIOInput"]
...
# FAS_GetIOInput 함수정의
FAS_GetIOInput_Original = EziMOTIONPlusR_dll["FAS_GetIOInput"]
...
FAS_SetIOOutput_Original = EziMOTIONPlusR_dll["FAS_SetIOOutput"]
...
FAS_GetIOOutput_Original = EziMOTIONPlusR_dll["FAS_GetIOOutput"]
...
FAS_GetIOAssignMap_Original = EziMOTIONPlusR_dll["FAS_GetIOAssignMap"]
...
FAS_SetIOAssignMap_Original = EziMOTIONPlusR_dll["FAS_SetIOAssignMap"]
...
FAS_IOAssignMapReadROM_Original = EziMOTIONPlusR_dll["FAS_IOAssignMapReadROM"]
FAS_IOAssignMapReadROM_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
...
FAS_ServoEnable_Original = EziMOTIONPlusR_dll["FAS_ServoEnable"]
FAS_ServoEnable_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_int]
FAS_ServoEnable_Original.restype = ctypes.c_int


# FAS_ServoAlarmReset 함수정의
FAS_ServoAlarmReset_Original = EziMOTIONPlusR_dll["FAS_ServoAlarmReset"]
FAS_ServoAlarmReset_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_ServoAlarmReset_Original.restype = ctypes.c_int


# FAS_StepAlarmReset 함수정의
FAS_StepAlarmReset_Original = EziMOTIONPlusR_dll["FAS_StepAlarmReset"]
FAS_StepAlarmReset_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_int]
FAS_StepAlarmReset_Original.restype = ctypes.c_int


# FAS_BrakeSet 함수정의
FAS_BrakeSet_Original = EziMOTIONPlusR_dll["FAS_BrakeSet"]
...
FAS_GetAxisStatus_Original = EziMOTIONPlusR_dll["FAS_GetAxisStatus"]
...
FAS_GetIOAxisStatus_Original = EziMOTIONPlusR_dll["FAS_GetIOAxisStatus"]
...
FAS_GetMotionStatus_Original = EziMOTIONPlusR_dll["FAS_GetMotionStatus"]
...
FAS_GetAllStatus_Original = EziMOTIONPlusR_dll["FAS_GetAllStatus"]
...
FAS_GetAllStatusEx_Original = EziMOTIONPlusR_dll["FAS_GetAllStatusEx"]
...
FAS_SetCommandPos_Original = EziMOTIONPlusR_dll["FAS_SetCommandPos"]
FAS_SetCommandPos_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_int]
FAS_SetCommandPos_Original.restype = ctypes.c_int


# FAS_SetActualPos 함수정의
FAS_SetActualPos_Original = EziMOTIONPlusR_dll["FAS_SetActualPos"]
FAS_SetActualPos_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_int]
FAS_SetActualPos_Original.restype = ctypes.c_int


# FAS_ClearPosition 함수정의
FAS_ClearPosition_Original = EziMOTIONPlusR_dll["FAS_ClearPosition"]
FAS_ClearPosition_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_ClearPosition_Original.restype = ctypes.c_int


# FAS_GetCommandPos 함수정의
FAS_GetCommandPos_Original = EziMOTIONPlusR_dll["FAS_GetCommandPos"]
...
FAS_GetActualPos_Original = EziMOTIONPlusR_dll["FAS_GetActualPos"]
...
FAS_GetPosError_Original = EziMOTIONPlusR_dll["FAS_GetPosError"]
...
FAS_GetActualVel_Original = EziMOTIONPlusR_dll["FAS_GetActualVel"]
FAS_GetActualVel_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_int)
]
FAS_GetActualVel_Original.restype = ctypes.c_int


# FAS_GetAlarmType 함수 정의
FAS_GetAlarmType_Original = EziMOTIONPlusR_dll["FAS_GetAlarmType"]
...
# ------------------------------------------------------------------
# FAS_MoveStop 함수 정의
FAS_MoveStop_Original = EziMOTIONPlusR_dll["FAS_MoveStop"]
FAS_MoveStop_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_MoveStop_Original.restype = ctypes.c_int


# FAS_EmergencyStop 함수 정의
FAS_EmergencyStop_Original = EziMOTIONPlusR_dll["FAS_EmergencyStop"]
FAS_EmergencyStop_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_EmergencyStop_Original.restype = ctypes.c_int


# FAS_MovePause 함수 정의
FAS_MovePause_Original = EziMOTIONPlusR_dll["FAS_MovePause"]
FAS_MovePause_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_int]
FAS_MovePause_Original.restype = ctypes.c_int


# FAS_MoveOriginSingleAxis 함수 정의
FAS_MoveOriginSingleAxis_Original = EziMOTIONPlusR_dll["FAS_MoveOriginSingleAxis"]
FAS_MoveOriginSingleAxis_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_MoveOriginSingleAxis_Original.restype = ctypes.c_int


# FAS_MoveSingleAxisAbsPos 함수 정의
FAS_MoveSingleAxisAbsPos_Original = EziMOTIONPlusR_dll["FAS_MoveSingleAxisAbsPos"]
...
FAS_MoveSingleAxisIncPos_Original = EziMOTIONPlusR_dll["FAS_MoveSingleAxisIncPos"]
...
FAS_MoveToLimit_Original = EziMOTIONPlusR_dll["FAS_MoveToLimit"]
...
FAS_MoveVelocity_Original = EziMOTIONPlusR_dll["FAS_MoveVelocity"]
...
FAS_PositionAbsOverride_Original = EziMOTIONPlusR_dll["FAS_PositionAbsOverride"]
...
FAS_PositionIncOverride_Original = EziMOTIONPlusR_dll["FAS_PositionIncOverride"]
...
FAS_VelocityOverride_Original = EziMOTIONPlusR_dll["FAS_VelocityOverride"]
...
FAS_MoveLinearAbsPos_Original = EziMOTIONPlusR_dll["FAS_MoveLinearAbsPos"]
...
FAS_MoveLinearIncPos_Original = EziMOTIONPlusR_dll["FAS_MoveLinearIncPos"]
...
FAS_MoveLinearAbsPos2_Original = EziMOTIONPlusR_dll["FAS_MoveLinearAbsPos2"]
...
FAS_MoveLinearIncPos2_Original = EziMOTIONPlusR_dll["FAS_MoveLinearIncPos2"]
...
FAS_MoveCircleAbsPos1_Original = EziMOTIONPlusR_dll["FAS_MoveCircleAbsPos1"]
...
FAS_MoveCircleIncPos1_Original = EziMOTIONPlusR_dll["FAS_MoveCircleIncPos1"]
...
FAS_MoveCircleAbsPos2_Original = EziMOTIONPlusR_dll["FAS_MoveCircleAbsPos2"]
...
FAS_MoveCircleIncPos2_Original = EziMOTIONPlusR_dll["FAS_MoveCircleIncPos2"]
...
FAS_MoveCircleAbsPos3_Original = EziMOTIONPlusR_dll["FAS_MoveCircleAbsPos3"]
...
FAS_MoveCircleIncPos3_Original = EziMOTIONPlusR_dll["FAS_MoveCircleIncPos3"]
...
FAS_TriggerOutput_RunA_Original = EziMOTIONPlusR_dll["FAS_TriggerOutput_RunA"]
...
FAS_TriggerOutput_Status_Original = EziMOTIONPlusR_dll["FAS_TriggerOutput_Status"]
...
FAS_SetTriggerOutputEx_Original = EziMOTIONPlusR_dll["FAS_SetTriggerOutputEx"]
...
FAS_GetTriggerOutputEx_Original = EziMOTIONPlusR_dll["FAS_GetTriggerOutputEx"]
...
# FAS_MovePush 함수 정의
FAS_MovePush_Original = EziMOTIONPlusR_dll["FAS_MovePush"]
...
FAS_GetPushStatus_Original = EziMOTIONPlusR_dll["FAS_GetPushStatus"]
...
FAS_MoveSingleAxisAbsPosEx_Original = EziMOTIONPlusR_dll["FAS_MoveSingleAxisAbsPosEx"]
...
FAS_MoveSingleAxisIncPosEx_Original = EziMOTIONPlusR_dll["FAS_MoveSingleAxisIncPosEx"]
...
FAS_MoveVelocityEx_Original = EziMOTIONPlusR_dll["FAS_MoveVelocityEx"]
...
# ------------------------------------------------------------------
# FAS_AllMoveStop 함수 정의
FAS_AllMoveStop_Original = EziMOTIONPlusR_dll["FAS_AllMoveStop"]
FAS_AllMoveStop_Original.argtypes = [ctypes.c_ubyte]
FAS_AllMoveStop_Original.restype = ctypes.c_int


# FAS_AllEmergencyStop 함수 정의
FAS_AllEmergencyStop_Original = EziMOTIONPlusR_dll["FAS_AllEmergencyStop"]
FAS_AllEmergencyStop_Original.argtypes = [ctypes.c_ubyte]
FAS_AllEmergencyStop_Original.restype = ctypes.c_int


# FAS_AllMoveOriginSingleAxis 함수 정의
FAS_AllMoveOriginSingleAxis_Original = EziMOTIONPlusR_dll["FAS_AllMoveOriginSingleAxis"]
FAS_AllMoveOriginSingleAxis_Original.argtypes = [ctypes.c_ubyte]
FAS_AllMoveOriginSingleAxis_Original.restype = ctypes.c_int


# FAS_AllMoveSingleAxisAbsPos 함수 정의
FAS_AllMoveSingleAxisAbsPos_Original = EziMOTIONPlusR_dll["FAS_AllMoveSingleAxisAbsPos"]
FAS_AllMoveSingleAxisAbsPos_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_int,
    ctypes.c_uint
]
FAS_AllMoveSingleAxisAbsPos_Original.restype = ctypes.c_int


# FAS_AllMoveSingleAxisIncPos 함수 정의
FAS_AllMoveSingleAxisIncPos_Original = EziMOTIONPlusR_dll["FAS_AllMoveSingleAxisIncPos"]
FAS_AllMoveSingleAxisIncPos_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_int,
    ctypes.c_uint
]
FAS_AllMoveSingleAxisIncPos_Original.restype = ctypes.c_int
...
FAS_PosTableReadItem_Original = EziMOTIONPlusR_dll["FAS_PosTableReadItem"]
...
FAS_PosTableWriteItem_Original = EziMOTIONPlusR_dll["FAS_PosTableWriteItem"]
...
FAS_PosTableWriteROM_Original = EziMOTIONPlusR_dll["FAS_PosTableWriteROM"]
FAS_PosTableWriteROM_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_PosTableWriteROM_Original.restype = ctypes.c_int


# FAS_PosTableReadROM 함수 정의
FAS_PosTableReadROM_Original = EziMOTIONPlusR_dll["FAS_PosTableReadROM"]
FAS_PosTableReadROM_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_PosTableReadROM_Original.restype = ctypes.c_int


# FAS_PosTableRunItem 함수 정의
FAS_PosTableRunItem_Original = EziMOTIONPlusR_dll["FAS_PosTableRunItem"]
...
FAS_PosTableReadOneItem_Original = EziMOTIONPlusR_dll["FAS_PosTableReadOneItem"]
...
FAS_PosTableWriteOneItem_Original = EziMOTIONPlusR_dll["FAS_PosTableWriteOneItem"]
...
FAS_PosTableSingleRunItem_Original = EziMOTIONPlusR_dll["FAS_PosTableSingleRunItem"]
...
FAS_GapControlEnable_Original = EziMOTIONPlusR_dll["FAS_GapControlEnable"]
...
FAS_GapControlDisable_Original = EziMOTIONPlusR_dll["FAS_GapControlDisable"]
FAS_GapControlDisable_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_GapControlDisable_Original.restype = ctypes.c_int


# FAS_IsGapControlEnable 함수 정의
FAS_IsGapControlEnable_Original = EziMOTIONPlusR_dll["FAS_IsGapControlEnable"]
...
FAS_GapControlGetADCValue_Original = EziMOTIONPlusR_dll["FAS_GapControlGetADCValue"]
...
FAS_GapOneResultMonitor_Original = EziMOTIONPlusR_dll["FAS_GapOneResultMonitor"]
...
FAS_GetAlarmLogs_Original = EziMOTIONPlusR_dll["FAS_GetAlarmLogs"]
...
FAS_ResetAlarmLogs_Original = EziMOTIONPlusR_dll["FAS_ResetAlarmLogs"]
FAS_ResetAlarmLogs_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
...
# ------------------------------------------------------------------
# FAS_GetInput 함수 정의
FAS_GetInput_Original = EziMOTIONPlusR_dll["FAS_GetInput"]
...
FAS_ClearLatch_Original = EziMOTIONPlusR_dll["FAS_ClearLatch"]
FAS_ClearLatch_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_uint]
FAS_ClearLatch_Original.restype = ctypes.c_int


# FAS_GetLatchCount 함수 정의
FAS_GetLatchCount_Original = EziMOTIONPlusR_dll["FAS_GetLatchCount"]
...
FAS_GetLatchCountAll_Original = EziMOTIONPlusR_dll["FAS_GetLatchCountAll"]
FAS_GetLatchCountAll_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_uint * 16)
]
FAS_GetLatchCountAll_Original.restype = ctypes.c_int


# FAS_GetLatchCountAll32 함수 정의
FAS_GetLatchCountAll32_Original = EziMOTIONPlusR_dll["FAS_GetLatchCountAll32"]
FAS_GetLatchCountAll32_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_uint * 32)
]
FAS_GetLatchCountAll32_Original.restype = ctypes.c_int


# FAS_ClearLatchCount 함수 정의
FAS_ClearLatchCount_Original = EziMOTIONPlusR_dll["FAS_ClearLatchCount"]
FAS_ClearLatchCount_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_uint]
FAS_ClearLatchCount_Original.restype = ctypes.c_int


# FAS_GetOutput 함수 정의
FAS_GetOutput_Original = EziMOTIONPlusR_dll["FAS_GetOutput"]
...
# FAS_SetOutput 함수 정의
FAS_SetOutput_Original = EziMOTIONPlusR_dll["FAS_SetOutput"]
...
FAS_SetTrigger_Original = EziMOTIONPlusR_dll["FAS_SetTrigger"]
...
FAS_SetRunStop_Original = EziMOTIONPlusR_dll["FAS_SetRunStop"]
...
FAS_GetTriggerCount_Original = EziMOTIONPlusR_dll["FAS_GetTriggerCount"]
...
FAS_GetIOLevel_Original = EziMOTIONPlusR_dll["FAS_GetIOLevel"]
...
FAS_SetIOLevel_Original = EziMOTIONPlusR_dll["FAS_SetIOLevel"]
FAS_SetIOLevel_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_uint]
FAS_SetIOLevel_Original.restype = ctypes.c_int


# FAS_LoadIOLevel 함수 정의
FAS_LoadIOLevel_Original = EziMOTIONPlusR_dll["FAS_LoadIOLevel"]
FAS_LoadIOLevel_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_LoadIOLevel_Original.restype = ctypes.c_int


# FAS_SaveIOLevel 함수 정의
FAS_SaveIOLevel_Original = EziMOTIONPlusR_dll["FAS_SaveIOLevel"]
FAS_SaveIOLevel_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_SaveIOLevel_Original.restype = ctypes.c_int


# FAS_GetInputFilter 함수 정의
FAS_GetInputFilter_Original = EziMOTIONPlusR_dll["FAS_GetInputFilter"]
...
FAS_SetInputFilter_Original = EziMOTIONPlusR_dll["FAS_SetInputFilter"]
FAS_SetInputFilter_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_ushort]
FAS_SetInputFilter_Original.restype = ctypes.c_int


# FAS_GetIODirection 함수 정의
FAS_GetIODirection_Original = EziMOTIONPlusR_dll["FAS_GetIODirection"]
...
FAS_SetIODirection_Original = EziMOTIONPlusR_dll["FAS_SetIODirection"]
FAS_SetIODirection_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte, ctypes.c_uint]
...
FAS_SetADConfig_Original = EziMOTIONPlusR_dll["FAS_SetADConfig"]
...
FAS_GetADConfig_Original = EziMOTIONPlusR_dll["FAS_GetADConfig"]
...
FAS_LoadADConfig_Original = EziMOTIONPlusR_dll["FAS_LoadADConfig"]
FAS_LoadADConfig_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_LoadADConfig_Original.restype = ctypes.c_int


# FAS_SaveADConfig 함수 정의
FAS_SaveADConfig_Original = EziMOTIONPlusR_dll["FAS_SaveADConfig"]
FAS_SaveADConfig_Original.argtypes = [ctypes.c_ubyte, ctypes.c_ubyte]
FAS_SaveADConfig_Original.restype = ctypes.c_int


# FAS_ReadADValue 함수 정의
FAS_ReadADValue_Original = EziMOTIONPlusR_dll["FAS_ReadADValue"]
...
FAS_ReadADAllValue_Original = EziMOTIONPlusR_dll["FAS_ReadADAllValue"]
...
FAS_GetAllADResult_Original = EziMOTIONPlusR_dll["FAS_GetAllADResult"]
FAS_GetAllADResult_Original.argtypes = [
    ctypes.c_ubyte,
    ctypes.c_ubyte,
    ctypes.POINTER(AD_RESULT)
]
FAS_GetAllADResult_Original.restype = ctypes.c_int


# FAS_GetADResult 함수 정의
FAS_GetADResult_Original = EziMOTIONPlusR_dll["FAS_GetADResult"]
...
FAS_SetADRange_Original = EziMOTIONPlusR_dll["FAS_SetADRange"]
