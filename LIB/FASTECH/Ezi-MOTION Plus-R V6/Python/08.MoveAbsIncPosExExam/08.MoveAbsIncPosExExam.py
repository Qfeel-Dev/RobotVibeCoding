...
def MovePos(nPortNo: int, iSlaveNo: int, nDistance: int, nAccDecTime: int) -> bool:
    ...
    # Set Acc Time
    if FAS_SetParameter(nPortNo, iSlaveNo, SERVO_AXISACCTIME, nAccDecTime) != FMM_OK:
        print("Function(FAS_SetParameter) was failed.")
        return False

    # Set Dec Time
    if FAS_SetParameter(nPortNo, iSlaveNo, SERVO_AXISDECTIME, nAccDecTime) != FMM_OK:
        print("Function(FAS_SetParameter) was failed.")
        return False
...
def MovePosEx(nPortNo: int, iSlaveNo: int, nDistance: int, nAccDecTime: int) -> bool:
...
def main():
    ...
    distance = 100000
    accdec = 100
    if not MovePos(nPortNo, iSlaveNo, distance, accdec):
        input("Press Enter to exit...")
    ...
    distance = -100000
    accdec = 100
    if not MovePosEx(nPortNo, iSlaveNo, distance, accdec):
        input("Press Enter to exit...")
