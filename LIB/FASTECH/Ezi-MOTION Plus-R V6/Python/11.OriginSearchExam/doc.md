...
You can check those parameter numbers in the corresponding define file (MOTION_SERVO_DEFINE.py for Ezi-SERVO Plus-R). 
...
설정하고자 하는 파라미터의 번호는 해당하는 define 파일(Ezi-SERVO Plus-R의 경우 MOTION_SERVO_DEFINE.py)에서 확인하실 수 있습니다. 
